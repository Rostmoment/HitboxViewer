...
{
    public static class SphereDisplayerHelper
    {
        ...
        {
            Vector3[] xz = CircleDisplayerHelper.DrawCircle(center, worldRadius, Enums.Plane.XZ, pointsPerRadius);
            Vector3[] xy = CircleDisplayerHelper.DrawCircle(center, worldRadius, Enums.Plane.XY, pointsPerRadius);
        ...
        {
            Vector3[] xz = CircleDisplayerHelper.DrawCircle(center, worldRadius, Enums.Plane.XZ, pointsPerRadius);
            Vector3[] yz = CircleDisplayerHelper.DrawCircle(center, worldRadius, Enums.Plane.YZ, pointsPerRadius);
            CircleDisplayerHelper.DrawAllCircleQuarters(center, worldRadius, Enums.Plane.XY, out Vector3[] xyFirst, out Vector3[] xySecond, out Vector3[] xyThird, out Vector3[] xyFourth, pointsPerRadius);
